...
<header
	class={[
		'fixed inset-x-0 bottom-0 z-10 sm:top-0 sm:bottom-auto',
		!home && 'bg-bg shadow-[0_-1px_3px_rgba(0,0,0,0.06)] sm:shadow-[0_1px_3px_rgba(0,0,0,0.06)]'
	]}
>
	<nav class="mx-auto flex max-w-207.5 items-center gap-4 px-6 py-2">
		<a
			href="/"
			class={['mr-auto text-[2rem] leading-12 text-body hover:no-underline', home && 'invisible']}
			>Hause</a
		>
		{#if !home}
